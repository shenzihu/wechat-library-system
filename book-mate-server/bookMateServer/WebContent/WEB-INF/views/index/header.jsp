...
<header>
    ...
    <div class="am-fl tpl-header-logo">
        <img src="${pageContext.request.contextPath }/assets/img/index-logo.png" style="width:30px; height: 30px; float: left; margin-top:14px; margin-left: 15px;">
       	<div style="color: #cfcfcf; line-height: 57px; margin-left:5px; font-weight:bold; float: left;">图书登记后台管理</div>
    </div>
    <!-- 右侧内容 -->
        ...
        <div class="am-fr tpl-header-navbar">
            <ul>
                ...
                <li class="am-text-sm tpl-header-navbar-welcome">
                    <a href="javascript:;">欢迎您, <span>${sessionScope.admin.adminUsername }</span> </a>
                </li>
