                                        ...
                                        <tbody>
                                        	<c:forEach items="${requestScope.pageUsers }" var="users">
	                                            <tr class="gradeX">
                                                    ...
                                                    <td class="am-text-middle">${users.realName}</td>
                                                    <td class="am-text-middle">${users.department}</td>
                                                    <td class="am-text-middle">
	                                                	<fmt:formatDate value="${users.userCreateTime}" pattern="yyyy-MM-dd HH:mm:ss"/>
	                                                </td>
	                                                <td class="am-text-middle">
